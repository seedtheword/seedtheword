...
(function () {
  ...
  function customBibleInspoHtml() {
    ...
    return '<div class="store-inspo" style="grid-column:1/-1;">' +
        ...
        '<p class="store-inspo__sub">Hand-painted with prayer and care — no set price, just give as the Spirit leads. <span class="shimmer-gift">✨ Most give $20 on average ✨</span> Start a bundle and choose <strong>“Cover painting”</strong>.</p>' +
